...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        NamedCommands.registerCommand("intake", Commands.defer(() -> intake.intakeUntilCancelledCommand(), Set.of(intake)));
   ...
   /** Unclog: run feeder and indexer in reverse at ~20% speed; intake extaking. While held. */
    ...
    /**
     * Teleop shoot with optional angle bypass. When ignoreAimError is true, feeds regardless of heading to target.
     */
